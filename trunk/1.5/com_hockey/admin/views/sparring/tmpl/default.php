    ...
    <table class="adminlist">
        ...
        <tbody>
            ...
            foreach ($this->items as $row) {
                ...
                $link = JRoute::_('index.php?option=' . $this->option . '&section=report1&type=2&id_match=' . $row->id);
                $link1 = JRoute::_('index.php?option=' . $this->option . '&section=report2&type=2&id_match=' . $row->id);
                $link2 = JRoute::_('index.php?option=' . $this->option . '&section=report3&type=2&id_match=' . $row->id);
                $link3 = JRoute::_('index.php?option=' . $this->option . '&section=report4&type=2&id_match=' . $row->id);
                $link4 = JRoute::_('index.php?option=' . $this->option . '&section=report5&type=2&id_match=' . $row->id);
                $link5 = JRoute::_('index.php?option=' . $this->option . '&section=report6&type=2&id_match=' . $row->id);
                $link6 = JRoute::_('index.php?option=' . $this->option . '&section=report7&type=2&id_match=' . $row->id);
            ?>
