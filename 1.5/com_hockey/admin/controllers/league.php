...
class HockeyControllerLeague extends MainController {
    ...
    function multipleAdd() {
       JRequest::setVar ( 'hidemainmenu', 1 );
       $view = & $this->getView('leagueday', 'html');
       $model1 = & $this->getModel('matches');
       $model2 = & $this->getModel('teams');
       $view->setModel($model1, true);
       $view->setModel($model2, false);
    ...
    function save() {
        ...
        $link = 'index.php?option=' . $this->_option . '&section=league';
    ...
    function publish() {
        ...
        $this->setRedirect ( 'index.php?option=' . $this->_option . '&section=league' );
    }
